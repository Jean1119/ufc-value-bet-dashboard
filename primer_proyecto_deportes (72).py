...
HEADER_BG = "https://media.giphy.com/media/3o7TKH4D5Z3tRxM3jC/giphy.gif"
...
def fetch_upcoming_odds():
    ...
    try:
        resp = requests.get(url, timeout=12)  # 12 sec timeout
    except Exception as e:
...
def style_value_bets(df):
    ...
    # Pandas 2.x: use .map instead of .applymap
    styled = df.style
